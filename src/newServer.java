...
public class newServer {
	...
	public static RedisOperator op = null;
	
	public static void main(String[] args) {
//		$APP_HOST $APP_PORT $DB_HOST $DB_PORT $DB_NAME $DB_USER $DB_PASS $REDIS_HOST $REDIS_PORT
		APP_HOST = args[0];
		APP_PORT = Integer.parseInt(args[1]);
		DB_HOST = args[2];
		...
		DB_PASS = args[6];
		REDIS_HOST = args[7];
		REDIS_PORT = Integer.parseInt(args[8]);
	...
	public static void start() throws IOException {
		...
		HttpServer httpServer = provider.createHttpServer(
				new InetSocketAddress(APP_PORT), 1000);
